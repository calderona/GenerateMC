...
usage = ""
parser = optparse.OptionParser(usage='\nExample: python %prog -i gridpacks/TrijetRes_g_ggg_BP2_test -n TrijetRes_g_ggg_BP2_test -t /tmp/santanas \n1) enter in a CMSSW area and do cmsenv \n2) Copy by hand new gridpacks (typically created in genproductions/bin/MadGraph5_aMCatNLO) in a new directory (i.e. gridpacks/TrijetRes_g_ggg_BP2_test) \n3) Launch the script %prog: the code creates a root file with the gen info of the produced samples')
